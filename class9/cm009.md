...
- Whether a dataframe is tidy or not is relative.
...
##    label         x      y
##    <chr>     <dbl>  <dbl>
##  1 Sample A  1.37   2.33 
##  2 Sample A  0.924  1.33 
##  3 Sample A -0.656 -1.06 
##  4 Sample A  1.52  -1.06 
##  5 Sample A -1.41  -1.86 
##  6 Sample A -0.977 -1.15 
##  7 Sample A -0.520 -1.07 
##  8 Sample A  1.08   2.73 
##  9 Sample A -1.72  -0.528
## 10 Sample A  0.128 -0.393
## # … with 90 more rows
```
...
# pair `name` and `treatment` together with `nesting()`
...
##   <chr>  <chr> <dbl>         <dbl>         <dbl>
## 1 Alex   a         1        0.895          0.681
## 2 Alex   a         2        0.0903         0.655
## 3 Alex   a         3        0.701          0.904
## 4 Robert b         1        0.379          0.634
## 5 Robert b         2        0.577          0.272
## 6 Robert b         3       NA             NA    
## 7 Sam    a         1        0.828          0.556
## 8 Sam    a         2       NA             NA    
## 9 Sam    a         3       NA             NA
```
